export const metadata = {
  title: "解約・退会 | AI美肌診断",
  description: "AI美肌診断の解約・退会手続きページです。",
};
      ...
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl p-8 text-white">
        ...
        <div className="space-y-4 text-sm text-gray-300 mb-8">
          ...
          <div className="bg-white/5 rounded-lg p-4">
            ...
            <a
              href="mailto:support@levona.design?subject=%E8%A7%A3%E7%B4%84%E5%B8%8C%E6%9C%9B%EF%BC%9AAI%E7%BE%8E%E8%82%8C%E8%A8%BA%E6%96%AD"
